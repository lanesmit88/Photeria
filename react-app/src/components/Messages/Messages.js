...
let messages = [
  { createdAt: "2020-12-29 13:19:19.141243-05", text: "Hey how are you" },
  { createdAt: "2020-12-29 13:19:19.141243-05", text: "Hey how are you" },
  { createdAt: "2020-12-29 13:19:19.141243-05", text: "Hey how are you" },
];
let messages2 = [
  { createdAt: "2021-12-29 13:19:19.141243-05", text: "Hey hjkfgk are you" },
...
function Messages() {
  const testing = () => {
    ...
    for (let i = 0; i < messages.length; i++) {
      for (let j = 0; j < messages2.length; j++) {
        if (Date.parse(messages[i]) >= Date.parse(messages2[j])) {
          array.push(
